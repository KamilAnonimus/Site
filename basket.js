...
document.onclick = event => {
    if (event.target.classList.contains('pay-the-bill') && localStorage.length > 0){
        alert('Поздравляю с покупкой!');
        localStorage.clear();
        document.getElementById('borders_basket').style.display='none';
    ...
    } else {checking_product_and_minus();}

    function checking_product_and_minus() {   
